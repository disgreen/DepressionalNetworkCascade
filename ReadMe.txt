...
To use the ExapleNetworkRun script download the DepressionalNetworkv2142023 and ExampleNetworkRun python files, and the 
...
The folder name "Outputs" contains copies of the files that are output by the ExampleNetworkRun script. 
